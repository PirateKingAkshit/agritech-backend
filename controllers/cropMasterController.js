...
const createCrop = [
  ...
  asyncHandler(async (req, res) => {
    ...
    const crop = await createCropService(cropData, req.user);
    res.status(200).json({ message: "Crop created successfully", data: crop });
  }),
];
